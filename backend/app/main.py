...
# 2026-06-08: تعديل لدعم Backblaze B2
...
# ==========================================
B2_ACCESS_KEY = os.getenv("B2_ACCESS_KEY_ID")
B2_SECRET_KEY = os.getenv("B2_SECRET_ACCESS_KEY")
B2_BUCKET = os.getenv("B2_BUCKET_NAME", "nrc-latrine-evidence")
B2_ENDPOINT = os.getenv("B2_ENDPOINT_URL")
MAX_IMAGE_SIZE = int(os.getenv("MAX_IMAGE_SIZE_MB", 2)) * 1024 * 1024
ALLOWED_MIME_TYPES = ["image/jpeg", "image/png", "image/webp"]
EXT_MAP = {"image/jpeg": "jpg", "image/png": "png", "image/webp": "webp"}

if B2_ACCESS_KEY and B2_SECRET_KEY and B2_ENDPOINT:
   s3_client = boto3.client('s3', endpoint_url=B2_ENDPOINT,
       aws_access_key_id=B2_ACCESS_KEY, aws_secret_access_key=B2_SECRET_KEY,
