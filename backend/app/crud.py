...
def create_remark(db: Session, remark: schemas.RemarkCreate):
    ...
    # Update remarks count on latrine
...
def seed_boq_items(db: Session, latrine_id: int):
    items = [
        ...
        {"boq_code": "B2", "category": "B-Septic & Pipes", "description_ar": "تمديد UPVC 4" + تهوية", "description_en": "UPVC Drainage", "unit": "LM", "planned_qty": 12.00},
